 ...
 * a shash table with a given size
 *
...
/**
 * add_n_shash - function that adds a node at the
...
/**
 * add_i_shash - function that adds a node
 * on the DLL of the shash table
 *
...
/**
 * shash_table_set - function that  adds a hash
