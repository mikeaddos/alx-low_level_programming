...
3. A door is what a dog is perpetually on the wrong side of Write a function that creates a new dog.
...
4. How many legs does a dog have if you call his tail a leg? Four. Saying that a tail is a leg doesn't make it a leg Write a function that frees dogs
